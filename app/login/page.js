                ...
                <div className="w-fit flex flex-col gap-10">
                    ...
                    <div className="flex flex-col ">
                        <div className="flex justify-between items-center">
                            <button className="w-1/2 aspect-[4/1] flex flex-col relative justify-center items-center " onClick={() => setIsSignIn(true)}>
                                <p className="text-xl font-medium">로그인</p>
                            </button>
                            <button className="w-1/2 aspect-[4/1] flex flex-col relative justify-center items-center " onClick={() => setIsSignIn(false)}>
